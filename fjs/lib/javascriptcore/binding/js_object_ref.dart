...
typedef JSObjectFinalizeCallbackDart = void Function(JSObjectRef object);
...
typedef JSObjectGetPropertyCallback = Pointer Function(JSContextRef ctx,
    JSObjectRef object, JSStringRef propertyName, JSValueRefRef exception);
typedef JSObjectGetPropertyCallbackDart = Pointer Function(JSContextRef ctx,
    JSObjectRef object, JSStringRef propertyName, JSValueRefRef exception);
...
typedef JSObjectSetPropertyCallback = Int8 Function(JSContextRef ctx, JSObjectRef object,
    JSStringRef propertyName, JSValueRef value, JSValueRefRef exception);
...
typedef JSObjectDeletePropertyCallback = Int8 Function(JSContextRef ctx,
    JSObjectRef object, JSStringRef propertyName, JSValueRefRef exception);
typedef JSObjectDeletePropertyCallbackDart = int Function(JSContextRef ctx,
    JSObjectRef object, JSStringRef propertyName, JSValueRefRef exception);
...
typedef JSObjectHasInstanceCallback = Int8 Function(JSContextRef ctx,
    JSObjectRef constructor, JSValueRef possibleInstance, JSValueRefRef exception);
typedef JSObjectHasInstanceCallbackDart = int Function(JSContextRef ctx,
    JSObjectRef constructor, JSValueRef possibleInstance, JSValueRefRef exception);
...
typedef JSObjectConvertToTypeCallback = Pointer Function(
    JSContextRef ctx, JSObjectRef object, Int8 type, JSValueRefRef exception);
typedef JSObjectConvertToTypeCallbackDart = Pointer Function(
    JSContextRef ctx, JSObjectRef object, int type, JSValueRefRef exception);
...
final JSObjectRef Function(JSContextRef ctx, Pointer jsClass, Pointer data)
    jSObjectMake = jscLib!
        .lookup<NativeFunction<JSObjectRef Function(JSContextRef, Pointer, Pointer)>>(
            'JSObjectMake')
        .asFunction();
...
final JSObjectRef Function(JSContextRef ctx, JSStringRef name,
        Pointer<NativeFunction<JSObjectCallAsFunctionCallback>> callAsFunction)
    jSObjectMakeFunctionWithCallback = jscLib!
        .lookup<NativeFunction<JSObjectRef Function(JSContextRef, JSStringRef, Pointer)>>(
...
final JSObjectRef Function(JSContextRef ctx, int argumentCount,
    JSValueRefArray arguments, JSValueRefRef exception)
    jSObjectMakeArray = jscLib!
        .lookup<
            NativeFunction<
                JSObjectRef Function(JSContextRef, Uint32, JSValueRefArray,
                    JSValueRefRef)>>('JSObjectMakeArray')
        .asFunction();
...
final JSObjectRef Function(JSContextRef ctx, int argumentCount,
    ...
    jSObjectMakeDate = jscLib!
        .lookup<
            NativeFunction<
                JSObjectRef Function(JSContextRef, Uint32, JSValueRefArray,
                    JSValueRefRef)>>('JSObjectMakeDate')
        .asFunction();
...
final JSObjectRef Function(JSContextRef ctx, int argumentCount,
    ...
    jSObjectMakeError = jscLib!
        .lookup<
            NativeFunction<
                JSObjectRef Function(JSContextRef, Uint32, JSValueRefArray,
                    JSValueRefRef)>>('JSObjectMakeError')
        .asFunction();
...
final JSObjectRef Function(JSContextRef ctx, int argumentCount,
    ...
    jSObjectMakeRegExp = jscLib!
        .lookup<
            NativeFunction<
                JSObjectRef Function(JSContextRef, Uint32, JSValueRefArray,
                    JSValueRefRef)>>('JSObjectMakeRegExp')
        .asFunction();
...
final JSObjectRef Function(JSContextRef ctx, JSObjectRefRef? resolve, JSObjectRefRef? reject,
        JSValueRefRef exception) jSObjectMakeDeferredPromise =
    jscLib!
        .lookup<
            NativeFunction<
                JSObjectRef Function(JSContextRef, JSObjectRefRef?, JSObjectRefRef?,
                    JSValueRefRef)>>('JSObjectMakeDeferredPromise')
        .asFunction();
...
final JSObjectRef Function(
    ...
    JSStringRef name,
        int parameterCount,
    JSStringRefArray parameterNames,
    JSStringRef body,
    JSStringRef sourceURL,
        int startingLineNumber,
        JSValueRefRef exception) jSObjectMakeFunction =
    jscLib!
        .lookup<
            NativeFunction<
                JSObjectRef Function(JSContextRef, JSStringRef, Int32, JSStringRefArray, JSStringRef,
                    JSStringRef, Int32, JSValueRefRef)>>('JSObjectMakeFunction')
        .asFunction();
...
final JSValueRef Function(JSContextRef ctx, JSObjectRef object) jSObjectGetPrototype =
    jscLib!
        .lookup<NativeFunction<JSValueRef Function(JSContextRef, JSObjectRef)>>(
...
final void Function(JSContextRef ctx, JSObjectRef object, JSValueRef value)
    jSObjectSetPrototype = jscLib!
        .lookup<NativeFunction<Void Function(JSContextRef, JSObjectRef, JSValueRef)>>(
...
final int Function(JSContextRef ctx, JSObjectRef object, JSStringRef propertyName)
    jSObjectHasProperty = jscLib!
        .lookup<NativeFunction<Int8 Function(JSContextRef, JSObjectRef, JSStringRef)>>(
            'JSObjectHasProperty')
        .asFunction();
...
final JSValueRef Function(JSContextRef ctx, JSObjectRef object, JSStringRef propertyName,
        JSValueRefRef exception) jSObjectGetProperty =
    jscLib!
        .lookup<
            NativeFunction<
                JSValueRef Function(JSContextRef, JSObjectRef, JSStringRef,
                    JSValueRefRef)>>('JSObjectGetProperty')
        .asFunction();
...
/// [exception] (JSValueRef*) A pointer to a JSValueRef in which to store an exception, if any. Pass NULL if you do not care to store an exception.
final void Function(JSContextRef ctx, JSObjectRef object, JSStringRef propertyName,
    JSValueRef value, int attributes, JSValueRefRef exception)
    jSObjectSetProperty = jscLib!
        .lookup<
            NativeFunction<
                Void Function(JSContextRef, JSObjectRef, JSStringRef, JSValueRef, Int32,
                    JSValueRefRef)>>('JSObjectSetProperty')
        .asFunction();
...
final int Function(JSContextRef ctx, JSObjectRef object, JSStringRef propertyName,
        JSValueRefRef exception) jSObjectDeleteProperty =
    jscLib!
        .lookup<
            NativeFunction<
                Int8 Function(JSContextRef, JSObjectRef, JSStringRef,
                    JSValueRefRef)>>('JSObjectDeleteProperty')
        .asFunction();
...
final int Function(JSContextRef ctx, JSObjectRef object, JSValueRef propertyKey,
        JSValueRefRef exception) jSObjectHasPropertyForKey =
    jscLib!
        .lookup<
            NativeFunction<
                Int8 Function(JSContextRef, JSObjectRef, JSValueRef,
                    JSValueRefRef)>>('JSObjectHasPropertyForKey')
        .asFunction();
...
final JSValueRef Function(JSContextRef ctx, JSObjectRef object, JSValueRef propertyKey,
        JSValueRefRef exception) jSObjectGetPropertyForKey =
    jscLib!
        .lookup<
            NativeFunction<
                JSValueRef Function(JSContextRef, JSObjectRef, JSValueRef,
                    JSValueRefRef)>>('JSObjectGetPropertyForKey')
        .asFunction();
...
/// [attributes] (JSPropertyAttributes) A logically ORed set of JSPropertyAttributes to give to the property.
/// [exception] (JSValueRef*) A pointer to a JSValueRef in which to store an exception, if any. Pass NULL if you do not care to store an exception.
final void Function(JSContextRef ctx, JSObjectRef object, JSValueRef propertyKey,
    JSValueRef value, int attributes, JSValueRefRef exception)
    jSObjectSetPropertyForKey = jscLib!
        .lookup<
            NativeFunction<
                Void Function(JSContextRef, JSObjectRef, JSValueRef, JSValueRef, Int32,
                    JSValueRefRef)>>('JSObjectSetPropertyForKey')
        .asFunction();
...
/// [@result] (bool) true if the delete operation succeeds, otherwise false (for example, if the property has the kJSPropertyAttributeDontDelete attribute set).
final int Function(JSContextRef ctx, JSObjectRef object, JSValueRef propertyKey,
        JSValueRefRef exception) jSObjectDeletePropertyForKey =
    jscLib!
        .lookup<
            NativeFunction<
                Int8 Function(JSContextRef, JSObjectRef, JSValueRef,
                    JSValueRefRef)>>('JSObjectDeletePropertyForKey')
        .asFunction();
...
/// [exception] (JSValueRef*) A pointer to a JSValueRef in which to store an exception, if any. Pass NULL if you do not care to store an exception.
/// [@result] (JSValueRef) The property's value if object has the property, otherwise the undefined value.
final JSValueRef Function(JSContextRef ctx, JSObjectRef object, int propertyIndex,
        JSValueRefRef exception) jSObjectGetPropertyAtIndex =
    jscLib!
        .lookup<
            NativeFunction<
                JSValueRef Function(JSContextRef, JSObjectRef, Int32,
                    JSValueRefRef)>>('JSObjectGetPropertyAtIndex')
        .asFunction();
...
/// [exception] (JSValueRef*) A pointer to a JSValueRef in which to store an exception, if any. Pass NULL if you do not care to store an exception.
final void Function(JSContextRef ctx, JSObjectRef object, int propertyIndex,
    JSValueRef value, JSValueRefRef exception) jSObjectSetPropertyAtIndex =
    jscLib!
        .lookup<
            NativeFunction<
                Void Function(JSContextRef, JSObjectRef, Int32, JSValueRef,
                    JSValueRefRef)>>('JSObjectSetPropertyAtIndex')
        .asFunction();
...
final Pointer Function(JSObjectRef object) jSObjectGetPrivate = jscLib!
    .lookup<NativeFunction<Pointer Function(JSObjectRef)>>('JSObjectGetPrivate')
    .asFunction();
...
final int Function(JSObjectRef object, Pointer data) jSObjectSetPrivate = jscLib!
    .lookup<NativeFunction<Int8 Function(JSObjectRef, Pointer)>>(
        'JSObjectSetPrivate')
    .asFunction();
...
final int Function(JSContextRef ctx, JSObjectRef object) jSObjectIsFunction = jscLib!
    .lookup<NativeFunction<Int8 Function(JSContextRef, JSObjectRef)>>(
        'JSObjectIsFunction')
    .asFunction();
...
final JSValueRef Function(JSContextRef ctx, JSObjectRef object, JSObjectRef thisObject,
        int argumentCount, JSValueRefArray arguments, JSValueRefRef exception)
    jSObjectCallAsFunction = jscLib!
        .lookup<
            NativeFunction<
                JSValueRef Function(JSContextRef, JSObjectRef, JSObjectRef, Uint32, JSValueRefArray,
                    JSValueRefRef)>>('JSObjectCallAsFunction')
        .asFunction();
...
final int Function(JSContextRef ctx, JSObjectRef object) jSObjectIsConstructor = jscLib!
    .lookup<NativeFunction<Int8 Function(JSContextRef, JSObjectRef)>>(
...
final JSObjectRef Function(JSContextRef ctx, JSObjectRef object, int argumentCount,
    JSValueRefArray arguments, JSValueRefRef exception)
    jSObjectCallAsConstructor = jscLib!
        .lookup<
            NativeFunction<
                JSObjectRef Function(JSContextRef, JSObjectRef, Uint32, JSValueRefArray,
                    JSValueRefRef)>>('JSObjectCallAsConstructor')
        .asFunction();
...
final Pointer Function(JSContextRef ctx, JSObjectRef object) jSObjectCopyPropertyNames =
    jscLib!
        .lookup<NativeFunction<Pointer Function(JSContextRef, JSObjectRef)>>(
...
final JSStringRef Function(Pointer array, int index)
    jSPropertyNameArrayGetNameAtIndex = jscLib!
        .lookup<NativeFunction<JSStringRef Function(Pointer, Uint32)>>(
...
final void Function(Pointer accumulator, JSStringRef propertyName)
    jSPropertyNameAccumulatorAddName = jscLib!
        .lookup<NativeFunction<Void Function(Pointer, JSStringRef)>>(
