...
// final Pointer<JSRuntime> Function() jsNewRuntime = qjsLib
//     .lookup<
//     NativeFunction<
//         Pointer<JSRuntime> Function()>>('JS_NewRuntime')
//     .asFunction();
//
// final void Function(
//     Pointer<JSRuntime>,
//     ) jsFreeRuntime = qjsLib
//     .lookup<
//     NativeFunction<
//         Void Function(
//             Pointer<JSRuntime>,
...
//     .asFunction();
//
// Pointer<JSValue> jsUndefined() {
//   return qjsLib.lookup('JS_UNDEFINED');
// }
//
// Pointer<JSValue> jsNull() {
//   return qjsLib.lookup('JS_NULL');
// }
//
// final Pointer<JSValue> Function(
//     Pointer<JSContext> ctx,
